...
<body>
	<div id="testheader">
		<div class="container">
			<div class=row>
				...
				<div class="col-md-6">
					<p>User: ${loginedUser.id} ${loginedUser.username}
						${loginedUser.role}</p>
					<p>
						Current Date :
						<%= new java.util.Date() %>
				...
				<div class="col-md-1">
					...
					<button class="btn-basic" id="lgnout-button">
	...
	<div class="sidenav">
		...
		<div class="dropdown-container">
			<a href="/Student/preAddCourse">Course Registration </a> <a
				href="/Student/StudentRegistration">Student Registration </a> <a
				href="/Student/SearchStudent">Student Search </a>
